...
public class Main {
    public static void main(String[] args) {
        ...
        // - la creation au moins 3 produits que vous ajoutez à la boutique avec la méthode `addProduit
        ...
        // on ajoute maintenant à la Boutique, des instances de ProduitElectronique, ProduitAlimentaire et ProduitBoisson au lieu de Produit
